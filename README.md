...
This project demonstrates a real-world end-to-end data analysis pipeline, starting from raw data processing to business reporting.
The Dataset has all 10000 rows.

The workflow includes:

Data Cleaning & EDA using Python (Jupyter Notebook)
...
## Step 2: Database Integration (MySQL via Jupyter Notebook)
